...
func main() {
	...
	daemon := app.New(logger, cfg.PollInterval, collectors, evaluator, incidentWriter, rawLogLinker, watchdogMetrics, cfg.IncidentDir, cfg.Retention.SweepInterval, cfg.Retention.Incidents)
